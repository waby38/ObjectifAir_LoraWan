...
#define BUS_I2C2_GPIO_PORT GPIOA
#define BUS_I2C2_GPIO_AF GPIO_AF4_I2C2
#define BUS_I2C2_GPIO_CLK_ENABLE() __HAL_RCC_GPIOA_CLK_ENABLE()
#define BUS_I2C2_GPIO_CLK_DISABLE() __HAL_RCC_GPIOA_CLK_DISABLE()
#define BUS_I2C2_SCL_GPIO_PIN GPIO_PIN_11
#define BUS_I2C2_SDA_GPIO_PIN GPIO_PIN_12

#ifndef BUS_I2C2_POLL_TIMEOUT
   #define BUS_I2C2_POLL_TIMEOUT                10000U
#endif
/* I2C2 Frequeny in Hz  */
#ifndef BUS_I2C2_FREQUENCY
   #define BUS_I2C2_FREQUENCY  100000U /* Frequency of I2Cn = 100 KHz for LCD display & SCD30*/
#endif
