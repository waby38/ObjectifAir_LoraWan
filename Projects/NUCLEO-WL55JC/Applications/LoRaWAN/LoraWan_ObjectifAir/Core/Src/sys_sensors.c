...
#define HUMIDITY_DEFAULT_VAL      00.0f                 /*!< default humidity */
#define TEMPERATURE_DEFAULT_VAL   0.0f                  /*!< default temperature */
#define PRESSURE_DEFAULT_VAL      000.0f                /*!< default pressure */
#define CO2_DEFAULT_VAL           0.0f                  /*!< default co2 */
/* USER CODE END PD */
...
int32_t  EnvSensors_Read(sensor_t *sensor_data)
{
  ...
  static float HUMIDITY_Value = HUMIDITY_DEFAULT_VAL;
...
#ifdef X_NUCLEO_IKS01A3
  /* Release I2C Bus twice */
  BSP_I2C1_DeInit();
  BSP_I2C1_DeInit();
#endif
